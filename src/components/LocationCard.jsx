    ...
    <div className="container-fluid">
      ...
      <div className="col">
        <div className="card border-warning border-4 rounded-0 card-css">
          <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5iwQ570pjjpihc6z2AKUV66fdNFfDLWZK996nCISNcxLcOogAKQKxnqqjzjBSEjujbMc&usqp=CAU' className="card-img-top rounded-0 card-img-css" alt={name} />
          <div className="card-body card-body-css">
            <div>
              <h5 className="card-title text-center mb-4" >{name}</h5>
            </div>
            <div className="d-flex justify-content-between ">
              <Link className="btn btn-warning" to={'/location_details/' + id}>Learn more!</Link>
