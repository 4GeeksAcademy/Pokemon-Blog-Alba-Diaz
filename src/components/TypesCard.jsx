...
export const TypesCard = ({ name, url }) => {
  let aux = url.split('/');
  const id = aux[6]
    ...
    <div className="container-fluid">
      ...
      <div className="col">
        <div className="card border-warning border-4 rounded-0 card-css">
          <img src='https://static.wikia.nocookie.net/monster-master/images/7/7c/Types.png/revision/latest/thumbnail/width/360/height/450?cb=20170525104825' className="card-img-top rounded-0 mt-3 card-img-css" alt={name} />
          <div className="card-body card-body-css">
            <h5 className="card-title text-center mb-4">{name}</h5>
            <div className="d-flex justify-content-between">
              <Link className="btn btn-warning" to={'/types_details/' + id}>Learn more!</Link>
